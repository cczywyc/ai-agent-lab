...
> 状态：**v0.5**（E1–E7 20/20 + v5.0 实现 + **真实 API 端到端实跑**；离线桩测 60/60+23/23+56/56；v0.5 据真实跑实测修两处缺陷（引用闸门 / escalate）；详见 [实验结论](../experiment/实验结论.md) 与 [search_agent/README](../search_agent/README.md)）
